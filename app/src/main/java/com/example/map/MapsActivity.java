...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void initializeUI(ActivityMapsBinding binding) {
        ...
        toggleSearchButton = binding.toggleSearchButton;
        searchCard = binding.searchCard;

        searchCityButton.setOnClickListener(v -> searchByCity());
        searchCoordinatesButton.setOnClickListener(v -> searchByCoordinates());

        toggleSearchButton.setOnClickListener(v -> toggleSearchSection());
    }
    ...
    private void toggleSearchSection() {
        ...
        toggleSearchButton.setText(isSearchVisible ? "Close" : "Open");
    }
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        LatLng pochinki = new LatLng(54.4221, 43.9261);
        mMap.addMarker(new MarkerOptions()
                .position(pochinki)
                .title("Marker in Pochinki"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(pochinki, 12f));
